...
using FFY.Tests.MVP.Administration.ProductManagement.AddCategoryPresenterTests.Mocks;
using Moq;
...
namespace FFY.Tests.MVP.Administration.ProductManagement.AddCategoryPresenterTests
{
    [TestFixture]
