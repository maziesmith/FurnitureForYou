...
using FFY.Tests.MVP.Administration.ProductManagement.EditProductPresenterTests.Mocks;
using Moq;
...
namespace FFY.Tests.MVP.Administration.ProductManagement.EditProductPresenterTests
{
    [TestFixture]
