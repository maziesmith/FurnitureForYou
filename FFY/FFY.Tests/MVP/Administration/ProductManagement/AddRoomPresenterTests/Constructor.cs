...
using FFY.Tests.MVP.Administration.ProductManagement.AddRoomPresenterTests.Mocks;
using Moq;
...
namespace FFY.Tests.MVP.Administration.ProductManagement.AddRoomPresenterTests
{
    [TestFixture]
