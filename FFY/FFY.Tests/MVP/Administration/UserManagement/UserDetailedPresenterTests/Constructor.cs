...
using FFY.Tests.MVP.Administration.UserManagement.UserDetailedPresenterTests.Mocks;
using Moq;
...
namespace FFY.Tests.MVP.Administration.UserManagement.UserDetailedPresenterTests
{
    [TestFixture]
