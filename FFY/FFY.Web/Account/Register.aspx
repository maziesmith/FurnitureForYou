<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="FFY.Web.Account.Register" %>
        ...
        <div class="form-horizontal center-form">
            ...
            <div class="form-group submit-button">
                <div class="col-md-offset-3 col-md-9">
                    <asp:Button Width="150px" runat="server" OnClick="CreateUser_Click" Text="Register" CssClass="btn btn-default" />
                </div>
            </div>
        </div>
</asp:Content>
