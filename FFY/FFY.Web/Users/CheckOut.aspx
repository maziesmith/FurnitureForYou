...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="City" CssClass="col-md-2 control-label">Street</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Country" CssClass="col-md-2 control-label">City</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="PhoneNumber" CssClass="col-md-2 control-label">Country</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="CheckOutOrder" Text="Create" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
